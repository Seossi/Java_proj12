...
public class OperatorEx03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 논리 연산자 (&&, ㅣㅣ, ^, !)쇼트 서킷이 발생됨  ( 앞부분의 연산 결과를 인지할 수 있을때 뒷부분은 연산을 생략 )
		 * 비트 연산자 (&, ㅣ, ^) 쇼트서킷이 발생되지 않는다.
		 * 		 */	
		...
		System.out.println((3<2) && (8<10));	//false
		System.out.println("=================");
		
		// or(||) : 두항중 하나만  true 이면 결과가 true 
		...
		// 숏 서킷을 사용 여부 ( 논리연산자일때 발생, 비트 연산자일때는 발생되지 않음.)
		...
		int value3 = 3;
		System.out.println(false & ++value3 > 6); //m false , 쇼트 서킷이 발생되지 않음.
		...
		System.out.println(value5);		// 쇼트서킷이 발생되지 않음.
