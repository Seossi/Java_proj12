...
public class OperationBetweenDataType {
	...
	public static void main(String[] args) {
		...
		// byte value55 = data1 + data2; //int 보다 작은 자료형은 연산 결과를 int 타입으로 변환
		...
		// short vlaue99 = data3 + data4; 
		int value9 = data3 + data4; // int 보다 작은 데이터 타입이 연산할 경우 int
