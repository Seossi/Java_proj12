...
//Aaa 클레스는 여러개의 생성자를 사용할 경우 this(); 없이 사용한 경우 : 중복된 값을 매번 입력
...
// Bbb 클라스는 여러개의 생성자를 사용할 경우 this(); 를 사용한 경우 : 중복된 값 제거
...
public class ThisMethod_2 {
	public static void main(String[] args) {
		...
		Aaa aaa3 = new Aaa(10,20);	// 매개 변수가 2개인 호출
		aaa1.print();
		aaa2.print();
		aaa3.print();
