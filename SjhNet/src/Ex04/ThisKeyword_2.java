...
// 명시적 this 키워드 추가 : 반드시 this key를 사용해야되는 경우 :
...
class Bb {			//this key 를 사용하는 경우
	int m;
	int n;
	void init (int m, int n) {
		this.m = m;			//this 키를 명시적으로 반드시 사용해서 m이 m 이라고 알려줘야 한다.
		this.n = n;
	}
...
public class ThisKeyword_2 {
	...
	public static void main(String[] args) {
		...
		// 1. 필드의 명과 지역변수의 명이 같은 경우 ( this 키워드를 사용하지 않는 경우 : 지역 변수에 저장 )
		Aa aa = new Aa();
		aa.init(2, 3);
