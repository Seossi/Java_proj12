...
public class If_Ex01 {
	...
	public static void main(String[] args) {
		...
		if (bool1) {
			...
			System.out.println("실행4");		// 조건이 flase 일때 실행
		}
		...
		if (bool2) {
			...
			System.out.println("실행6");		// 조건이 flase 일때 실행
		}
		System.out.println("====================");
		
		
		//if = else 는 삼항연상자로 변환이 가능
		
			System.out.println((bool1) ? "실행7 " : "실행8" ); 	//참이므로 "실행7"이 출력
			System.out.println((bool2) ? "실행7 " : "실행8" ); 	//참이므로 "실행8"이 출력
		...
		if (value3 >= 90) {
			...
			System.out.println("B학점, 점수 : " + value3); 	// 실행후 if 문을 빠져 나온다.
		...
		if (value3 >= 90) {
			...
			System.out.println("C학점, 점수 : " + value3); 	// 실행후 if 문을 빠져 나온다.
		...
		if ( 3 < 5 ) 
			System.out.println("Hi");  	//if 에서 {}가 생략된 경우
